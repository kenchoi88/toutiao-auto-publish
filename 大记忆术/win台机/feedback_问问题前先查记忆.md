...
- 2026-04-28 晚:看到 v1101.1 标记 0 处就臆想"仓库是假 v1101.1 / commit 62eb63e 是水货",还说出口给缺哥;实际上 `自动发布/版本说明.txt` 已经写明 v1101 是基线 / v1101.1 是熔断重构 6 条增量,看一眼就懂。**拿不准先查仓库,别先编叙事 — 编一个错的比说"我去查一下"成本高 10 倍**。

**How to apply:**
- **回答缺哥任何问题前** → 先 grep memory + 看 shared_memory/ + 看 自动发布/版本说明.txt + 看 自动发布/故障日志.txt,**确认了再答**;别凭印象 / 凭上下文揣测开口
